...
class TrainedModels(database.Model):
    ...
    class_name = database.Column(database.String(600), nullable=False)


    def __init__(self, model_name, dataset_name, training_alogrithm, accuracy, precision, recall, f1, folderName, number_of_features, class_name):
